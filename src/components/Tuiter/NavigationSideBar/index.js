...
const NavigationSidebar = ({}) => {
    ...
    return(
            ...
            <div className="list-group">
                ...
                <Link to="/tuiter/" className={`list-group-item ${active === '' ? 'active' : ''}`}><i className="fa-solid fa-house-chimney"></i><a className="d-none d-xl-inline" href="../HomeScreen"> Home</a></Link>
                ...
                <Link to="/tuiter/profile"className={`list-group-item ${active === 'profile' ? 'active' : ''}`}><i className="fa-solid fa-user"></i><a className="d-none d-xl-inline" href="../profile.html"> Profile</a></Link>
